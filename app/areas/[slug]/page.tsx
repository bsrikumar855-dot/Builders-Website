    ...
    <>
      ...
      <section className="gradient-brand py-16 md:py-24" aria-labelledby="area-heading">
        <div className="section-container max-w-3xl">
          <div className="flex items-center gap-2 text-slate-body text-sm mb-4">
          ...
          <p className="text-slate-body text-lg leading-relaxed mb-8 max-w-2xl">
            {area.description}
          </p>
      ...
      <section className="section-padding section-alt" aria-labelledby="area-highlights-heading">
        <div className="section-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 id="area-highlights-heading" className="text-graphite mb-6">
              ...
              <ul className="space-y-3">
                {area.highlights.map((h) => (
                  <li key={h} className="flex items-start gap-3 text-sm text-graphite">
      ...
      {areaServices.length > 0 && (
        <section className="section-padding" aria-labelledby="area-services-heading">
          <div className="section-container">
            <h2 id="area-services-heading" className="text-graphite text-center mb-10">
