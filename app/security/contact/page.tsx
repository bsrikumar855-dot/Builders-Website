...
export const metadata: Metadata = {
  title: "Contact Sabari Security | CCTV & Alarm Surveys Coimbatore",
  description:
    "Contact Sabari Security Service. Book a CCTV site threat assessment or security system survey. Serving Coimbatore since 2012.",
  alternates: { canonical: `${siteConfig.url}/security/contact` },
};
...
export default function ContactPage() {
  return (
    <>
      {/* Header */}
      <section className="relative overflow-hidden bg-security-primary text-warm-white py-16 md:py-20" aria-labelledby="contact-heading">
        <div className="section-container text-center max-w-2xl mx-auto relative z-10">
          <p className="text-security-accent text-xs font-bold uppercase tracking-widest mb-3">Get In Touch</p>
          <h1 id="contact-heading" className="text-white mb-4">Contact Sabari Security</h1>
          <p className="text-warm-white/80 text-lg">
            For urgent security issues or system failures, call immediately. For planned installs or site surveys, use the form below.
          </p>
        </div>
      </section>

      {/* Emergency Banner */}
      <div className="bg-security-accent text-warm-white py-4">
        <div className="section-container text-center">
          <p className="font-bold text-sm md:text-base">
            System offline or urgent fault?{" "}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <a href={`tel:${siteConfig.phone}`}
                className="group flex items-start gap-4 bg-white border border-warm-white rounded-xl p-5 hover:border-security-primary/20 hover:shadow-md transition-all">
                <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-security-primary to-security-accent flex items-center justify-center shrink-0">
                  <Phone className="w-5 h-5 text-white" />
                </div>
                <div>
                  <p className="text-xs font-bold uppercase tracking-wide text-slate-body mb-1">Phone (Calls & WhatsApp)</p>
                  <p className="text-lg font-bold text-graphite group-hover:text-security-primary transition-colors">{siteConfig.phone}</p>
                  <p className="text-xs text-slate-body/50 mt-1">Direct to security dispatch</p>
                </div>
              </a>
              ...
              <a href={`https://wa.me/${siteConfig.whatsapp}`} target="_blank" rel="noopener noreferrer"
                ...
                <div className="w-11 h-11 rounded-xl bg-security-accent flex items-center justify-center shrink-0">
              ...
              <a href={`mailto:${siteConfig.email}`}
                ...
                <div>
                  ...
                  <p className="text-base font-semibold text-graphite group-hover:text-security-primary transition-colors break-all">{siteConfig.email}</p>
                </div>
              </a>
              ...
              <div className="flex items-start gap-4 bg-white border border-warm-white rounded-xl p-5">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-security-accent mt-1">24/7 Operations Room</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-2xl border border-warm-white p-6 md:p-8">
                ...
                <p className="text-sm text-slate-body mb-6">
                  For site surveys and design estimates, please use our{" "}
                  <Link href="/security/quote" className="text-graphite font-semibold hover:underline">
                    survey request form
                  </Link>{" "}
                  instead.
                </p>
